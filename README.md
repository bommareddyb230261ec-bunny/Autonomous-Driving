...
Generated results and exported artifacts for this project are available here:

- [Google Drive output folder](https://drive.google.com/file/d/1CPLiVZIZqg_17bJxicpeKfTIvVqIAJTh/view?usp=sharing)
...
2. **Install OpenEMMA**  
 ...
 `
   Alternatively, follow these steps: - **Clone OpenEMMA Repository**  
...
This repository is maintained as a local project for autonomous driving experiments and evaluation using the nuScenes dataset.

The instructions above are intended to support running the pipeline, adapting the setup to your environment, and continuing development on this project as needed.
